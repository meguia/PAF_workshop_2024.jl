...
# ╔═╡ 236730be-d6ac-4144-a107-9eac5c50b86d
md"""
N $(@bind N Slider(1:40,default=10;show_value=true))
"""
...
md"""
k $(@bind k Slider(0:N-1,default=0;show_value=true)) 
"""
...
begin
	circ = exp.(1im*(0:pi/100:2*pi))
	p1 = plot(real(circ),imag(circ))
